...
function AttendeeSignUp() {
  const handleSubmit = async (event) => {
    ...
    // let successMessage = "successMessage d-none";
  ...
  let spinnerClasses = "d-flex justify-content-center mb-3 xavier";
  let dropdownClasses = "form-select d-none";
  let spinnerClass2 = "spinner-grow text-secondary";
  if (conferences.length > 0) {
    spinnerClasses = "d-flex justify-content-center mb-3 d-none";
    dropdownClasses = "form-select";
    spinnerClass2 = "spinner-grow text-secondary d-none";
  }
            ...
            <div className="card-body">
              <form onSubmit={handleSubmit} id="create-attendee-form">
                ...
                <div className="spinnerClasses" id="loading-conference-spinner">
                  <div className="spinnerClass2" role="status">
              ...
              {/* <Alert className="successMessage" variant="success">
                <Alert.Heading>
                  Congratulations! You're all signed up!
                </Alert.Heading>
              </Alert> */}
